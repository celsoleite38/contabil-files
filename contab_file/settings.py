...
WSGI_APPLICATION = 'contab_file.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'hzgl rfru mwoz drdy'
DEFAULT_FROM_EMAIL = 'CONTAB FILES <suporteinnosoft@gmail.com>'
